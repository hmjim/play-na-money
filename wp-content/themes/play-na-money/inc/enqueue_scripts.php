...
function scf_theme_scripts() {
	...
	// Подключаем стили
	wp_enqueue_style( 'montserrat-style', 'https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;700&display=swap' );
	wp_enqueue_style( 'notosans-style', 'https://fonts.googleapis.com/css2?family=Noto+Sans&display=swap' );
