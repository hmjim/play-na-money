	...
	<div class="slot__inner">
		<div class="slot__thumb">
			...
			<div class="slot__btns">
				<a href="<?php the_permalink(); ?>" class="btn btn-white" title="Играть в <?php the_title(); ?> онлайн">Бесплатно</a>
				<a href="<?= $link; ?>" class="btn btn-blue" title="<?php the_title(); ?> с выводом на карту" target="_blank">На деньги</a>
			</div>
		</div>
